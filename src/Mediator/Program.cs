...
namespace Mediator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Teacher veli = new Teacher(mediator);
            veli.Name = "Veli";

            mediator.Teacher = veli;

            Student sukru =new Student(mediator);
            sukru.Name = "Şükrü";
            ...
            mediator.Students = new List<Student>{sukru,burak};

            veli.SendNewImageUrl("slide1.jpg");
            veli.RecieveQuestion("is it true?",burak);
